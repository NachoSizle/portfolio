 ...
 * `src/components/SocialButton.astro` y con los `social.icon === '...'` del Footer.
 */
...
export function getFooterData(lang: keyof typeof ui = defaultLang): FooterData {
  ...
  const quickLinks: QuickLink[] = [
    { name: t('footer.links.home'), url: home },
    { name: t('footer.links.projects'), url: `${homeNoTrailing}/#projects` },
    { name: t('footer.links.about'), url: `${homeNoTrailing}/#about` },
    { name: t('footer.links.contact'), url: `${homeNoTrailing}/#contact` },
  ];
